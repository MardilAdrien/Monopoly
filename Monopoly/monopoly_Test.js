...
game_ns._draw_setup.draw_player_wrappers = function(max) {
  ...
  for (i = 1; i <= max; i++) {
	  content += "<div id='player"+i+"wrap' data-id='"+i+"' class='player-wrap col-sm-12'>";
	  content += "<label>Joueur "+i+": </label><br/>";
	  content += "<input type='text' class='player-name col-sm-12 form-control' title='Player name' maxlength='16' value='Joueur "+i+"' /> ";
